...
contract("AaveFlashLoan", (accounts) => {
  ...
  const FUND_AMOUNT = new BN(10).pow(new BN(DECIMALS)).mul(new BN(500)); //1000100, 2 million USDC
  ...
  beforeEach(async () => {
    ...
    console.log("balance of USDC in Whale:", bal.toString())
    ...
    console.log("Address AAveFlashLoan contract:", aaveFlashLoanInstance.address)
    ...
    it("aave simple flash loan", async () => {
        ...
        //{
        //from: WHALE,
        //from: aaveFlashLoanInstance.address,
        //}
        )
