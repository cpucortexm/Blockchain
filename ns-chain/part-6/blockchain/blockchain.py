...
class Chain:
    ...
    '''
    @classmethod
    def find_UnspentTransactions(cls, address):
    ...
    @classmethod
    def find_UTXO(cls,address):
        UTXOs = []  # list of variable of type TxOut
        unspenttxs = cls.find_UnspentTransactions(address)
    ...
    @classmethod
    def find_SpendableOutputs(cls, address, amount):
